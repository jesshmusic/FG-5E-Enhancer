...
--Debug.console("char_weapon_adnd.lua","onAttackAction","sRecord",sRecord);
	...
	rAction.modifier = DB.getValue(nodeWeapon, "attackbonus", 0) + ActorManager5E.getAbilityBonus(rActor, rAction.stat);
...
function onAttackChanged()
	...
	local nMod = DB.getValue(nodeWeapon, "attackbonus", 0) + ActorManager5E.getAbilityBonus(rActor, sAbility);
